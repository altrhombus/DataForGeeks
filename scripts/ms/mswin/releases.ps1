...
$d4gData = Invoke-WebRequest "https://raw.githubusercontent.com/altrhombus/DataForGeeks/main/content/ms/mswin/releases.json" | Select-Object -ExpandProperty Content | ConvertFrom-Json
